    ...
    <div className="bg-muted/30 pb-14">
      ...
      <div className="container-page pt-5 sm:pt-7">
        <nav className="mb-4 flex flex-wrap items-center gap-1 text-xs text-muted-foreground">
          ...
          <span>/</span>
          <Link href="/mua-ban-o-to" className="hover:text-primary">Mua bán ô tô</Link>
          <span>/</span>
          ...
          <div className="space-y-5">
            <section className="rounded-2xl border border-border bg-card p-5 sm:p-6">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Badge variant="outline">Đời {car.year}</Badge>
              </div>
              ...
              <div className="mt-4 flex flex-wrap gap-x-5 gap-y-2 text-sm text-muted-foreground">
                ...
                <span className="flex items-center gap-1.5"><Clock3 className="h-4 w-4 text-primary" /> Mã tin: {car.id.slice(0, 8).toUpperCase()}</span>
              </div>
            ...
            <section className="rounded-2xl border border-border bg-card p-5 sm:p-6">
              <h2 className="mb-4 font-display text-lg font-semibold">Thông số xe</h2>
              <CarSpecs car={car} />
            </section>

            {car.highlights?.length > 0 && (
              <section className="rounded-2xl border border-border bg-card p-5 sm:p-6">
                <h2 className="mb-4 font-display text-lg font-semibold">Điểm nổi bật</h2>
            ...
            <section className="rounded-2xl border border-border bg-card p-5 sm:p-6">
              <h2 className="mb-4 font-display text-lg font-semibold">Mô tả chi tiết</h2>
            ...
            <div className="flex gap-3 rounded-xl border border-success/20 bg-success/5 p-4 text-sm leading-relaxed text-foreground/80">
              ...
              Vui lòng liên hệ showroom để được tư vấn, hẹn xem xe và kiểm tra giấy tờ thực tế trước khi quyết định.
            </div>
          </div>
      ...
      {related.length > 0 && (
        <section className="container-page mt-10">
          <h2 className="mb-5 font-display text-xl font-bold">Xe cùng hãng {car.brandName}</h2>
